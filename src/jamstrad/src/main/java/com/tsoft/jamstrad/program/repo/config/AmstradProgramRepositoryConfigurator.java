package com.tsoft.jamstrad.program.repo.config;
...
import com.tsoft.jamstrad.program.repo.facet.Facet;
import com.tsoft.jamstrad.program.repo.facet.FacetFactory;
import com.tsoft.jamstrad.program.repo.facet.FacetList;
import com.tsoft.jamstrad.swing.*;
...
public class AmstradProgramRepositoryConfigurator extends Box {
	...
	private CardsInOrderPanel createFacetCardsInOrderPanel() {
		...
		panel.addListener(new CardsInOrderListener() {
			...
			private FacetList getFacetList(CardsInOrderPanel panel) {
				...
				for (CardsInOrderPanel.Card card : panel.getCardsInOrder()) {
	...
	private List<CardsInOrderPanel.Card> createAllFacetCards() {
		List<CardsInOrderPanel.Card> cards = new Vector<CardsInOrderPanel.Card>();
	...
	private static class FacetCard extends CardsInOrderPanel.Card {
