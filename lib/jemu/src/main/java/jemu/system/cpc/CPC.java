...
import jzoom.converter.Converter;
...
public class CPC extends Computer {
	...
	protected Hashtable<String, String> upperROMs = new Hashtable();
	...
	private void initCPCType(String name) {
		...
		// Set memory type for all models
		if (Switches.Memory.equals("TYPE_512K"))
			...
			memory = new CPCMemory(this, CPCMemory.TYPE_512K);
		//
		System.out.println("Memory chosen: " + Switches.Memory);
