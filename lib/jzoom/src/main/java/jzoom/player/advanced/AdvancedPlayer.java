...
package jzoom.player.advanced;

import java.io.InputStream;

import jzoom.decoder.Bitstream;
import jzoom.decoder.BitstreamException;
import jzoom.decoder.Decoder;
import jzoom.decoder.Header;
import jzoom.decoder.JavaLayerException;
import jzoom.decoder.SampleBuffer;
import jzoom.player.AudioDevice;
import jzoom.player.FactoryRegistry;

/**
 * a hybrid of jzoom.player.Player tweeked to include <code>play(startFrame, endFrame)</code>
